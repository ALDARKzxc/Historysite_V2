      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-white rounded-full px-3 py-1 mb-4 shadow-sm border border-[#EEF1F7]">
            ...
            <span className="text-xs font-medium text-[#2F5D9F] font-ui tracking-wide uppercase">18 Epochs</span>
          </div>
          <h2 className="font-display text-4xl md:text-5xl font-bold text-[#2A2A2A] mb-4">
            Explore Russian History
          </h2>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-full flex flex-col justify-end p-4">
                  ...
                  <p className="text-white/60 text-[10px] font-ui italic mb-2">{epoch.titleRu}</p>

                  {!isLarge && (
                    <div className="flex items-center justify-between">
                      <span className="text-white/70 text-xs font-ui">{epoch.topicCount} topics</span>
                    </div>
                  )}

                  {isLarge && (
                    <>
                      <p className="text-white/80 text-sm font-ui mb-3 line-clamp-2">{epoch.description}</p>
                      <div className="flex items-center justify-between">
                        <span className="text-white/70 text-xs font-ui">{epoch.topicCount} topics</span>
